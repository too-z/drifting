"""Torch port of utils/logging.py — identical WandbLogger; only the rank check
(jax.process_index -> dist_util.rank) and tensor coercion (jax.Array ->
torch.Tensor) differ."""
